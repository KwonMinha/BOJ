 ...
 * 우선순위 큐로 나무 나이순 정렬 + 죽거나 살아있는 나무 stack으로 관리 
 */
...
//			}
			...
			return this.age - o.age; // 나이만 오름차순 정렬하면 됨 - 첨에 위 코드와 같이 x, y, age 다 고려했다가 시간 초과 났음 
		}
	}
